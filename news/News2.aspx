<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="News2.aspx.cs" Inherits="News2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-main news-container">
        ...
        <img src="<%= Page.ResolveUrl("~")%>img/bar1.jpg" />
        <img src="<%= Page.ResolveUrl("~")%>img/bar2.jpg" />
        </div>
