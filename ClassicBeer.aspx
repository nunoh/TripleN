<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ClassicBeer.aspx.cs" Inherits="Beers_ClassicBeer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:100%; min-height:530px; clear:both; background:#ffffff url('img/classic_deg.jpg') no-repeat right top;">
        <div style="float:left; width:400px; padding:0 20px; ">
